...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn('h-6 px-2 text-left align-middle font-medium text-foreground wrap-break-word', className)}
      {...props}
    />
  );
}
...
function TableCell({ className, ...props }: React.ComponentProps<'td'>) {
  return (
    <td
      ...
      className={cn('px-2 py-1 align-middle wrap-break-word', className)}
      {...props}
    />
  );
}
